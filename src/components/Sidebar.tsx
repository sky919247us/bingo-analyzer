    ...
    return (
        <>
            ...
            <aside className={`sidebar${isOpen ? ' sidebar-open' : ''}`}>
                ...
                <div className="sidebar-footer" style={{ padding: '16px 20px', marginTop: 'auto', borderTop: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                    <a href="https://i168.win/" target="_blank" rel="noopener noreferrer" aria-label="刮刮研究室官網" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', width: '100%', padding: '10px 16px', background: 'linear-gradient(135deg, #f59e0b, #f97316)', color: '#fff', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '0.9rem', transition: 'transform 0.2s, box-shadow 0.2s', boxShadow: '0 2px 8px rgba(245, 158, 11, 0.3)' }}>
                        🎰 刮刮研究室
                    </a>
